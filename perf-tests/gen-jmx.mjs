...
// Run: node perf-tests/gen-jmx.mjs
// Produces:
//   perf-tests/karpathy-perf.jmx           (Plan A: deterministic read + login, 17 TGs)
//   perf-tests/karpathy-perf-ai.jmx        (Plan B: /api/query + /api/tags/suggest, mock-backed SSE)
//   perf-tests/karpathy-perf-write.jmx     (Plan C: login-concurrent + write-page + auth-me + auth-users)
//   perf-tests/karpathy-perf-compilelock.jmx (Plan D: /api/compile (mock) run concurrently with /api/stats)
//
// Design notes:
