...
- 备注：从 raw/Test Doc 1.md 编译为实体页面 test-doc-1

## 2026-07-22 05:00
- 操作类型：compile
- 影响文件：entities/test-doc-2.md
- 备注：编译 raw/Test Doc 2.md → entities/test-doc-2.md
...
- 备注：从 raw/proxy-test1.md 编译 Proxy Test 1 概念页，并创建关联的 Proxy 和 Network Test 概念页，建立双向链接网络。

## 2026-07-22 06:29
- 操作类型：compile
- 影响文件：entities/proxy-test-2.md, concepts/proxy-testing.md
- 备注：编译 raw/proxy-test2.md —— 创建 entity 页「Proxy Test 2」和 concept 页「Proxy Testing」，建立双向链接

## 2026-07-22 06:40
- 操作类型：compile
- 影响文件：concepts/batch-compile-test.md, concepts/knowledge-base-compilation.md, concepts/frontmatter-spec.md
- 备注：根据原始资料 raw/test-batch.md 编译批量编译测试概念页，并补充相关知识库编译和 frontmatter 规范页面，建立双向链接

## 2026-07-22 06:56
- 操作类型：compile
- 影响文件：concepts/等分化票据.md, concepts/ECDS融合.md, entities/新一代票据业务系统.md
- 备注：从原始资料 raw/ECDS__-________V2.X_.md 编译 ECDS融合项目实施指南相关内容，生成 3 个页面：等分化票据（概念）、ECDS融合（概念）、新一代票据业务系统（实体）
...
- 备注：根据 raw/1.____________________.md 编译：创建概念页「中国票据业务系统直连接口规范」与实体页「上海票据交易所」，建立双向链接
...
- 备注：从 raw/11.______________________.md 编译中国票据业务系统直连接口规范（银行账户分册）相关页面，包括概念页、两个报文实体页及上海票据交易所实体页。
...
- 备注：从 raw/中国票据业务系统直连接口规范（非交易分册）.md 编译中国票据业务系统直连接口规范（非交易分册）概念页，涵盖业务场景、报文清单、关键特性等，建立与上海票据交易所、中国票据业务系统等相关页面的双向链接。
...
- 备注：从 raw/test-1.md 编译：创建 Test Document 1 实体页及 Batch Compile Testing、Knowledge Compilation Pipeline 概念页，建立双向链接

## 2026-07-22 11:15
- 操作类型：compile
- 影响文件：entities/test-document-2.md, entities/batch-compile-test.md
- 备注：编译 raw/Test Document 2.md → entities/test-document-2.md，并创建关联实体 batch-compile-test

## 2026-07-22 11:15
- 操作类型：compile
- 影响文件：entities/test-document-3.md
- 备注：从 raw/test-3.md 编译 Test Document 3 实体页，建立与 batch-compile-testing、test-document-1、test-document-2、knowledge-compilation-pipeline 的双向链接

## 2026-07-22 11:15
- 操作类型：compile
- 影响文件：entities/test-document-4.md, concepts/batch-compile-testing.md, concepts/llm.md
- 备注：编译 raw/Test Document 4.md → entity: test-document-4，concept: batch-compile-testing, llm。建立双向链接，追加 index 摘要。

## 2026-07-22 11:16
- 操作类型：compile
- 影响文件：entities/test-document-5.md, concepts/batch-compile-testing.md
- 备注：Compiled raw/Test Document 5.md into two pages: entity (Test Document 5) and concept (Batch Compile Testing), with bidirectional links between them.

## 2026-07-22 11:16
- 操作类型：compile
- 影响文件：concepts/batch-compile-testing.md, entities/test-document-6.md
- 备注：根据 raw/Test Document 6.md 编译：创建批量编译测试概念页和测试文档实体页，建立双向链接。

## 2026-07-22 11:16
- 操作类型：compile
- 影响文件：concepts/batch-compile-testing.md, entities/test-document-7.md
- 备注：根据 raw/Test Document 7.md 编译：创建「批次编译测试」概念页和「Test Document 7」实体页，建立双向链接。

## 2026-07-22 11:16
- 操作类型：compile
- 影响文件：entities/test-document-8.md, entities/batch-compile-test.md, concepts/batch-compile.md
- 备注：编译 raw/test-8.md → 实体页 (test-document-8, batch-compile-test) + 概念页 (batch-compile)

## 2026-07-22 11:17
- 操作类型：compile
- 影响文件：concepts/batch-compile-testing.md, entities/test-document-9.md
- 备注：从 raw/Test Document 9.md 编译：创建了批量编译测试概念页和测试文档实体页，建立了双向链接

## 2026-07-22 11:17
- 操作类型：compile
- 影响文件：concepts/batch-compile-testing.md, concepts/llm-entity-extraction.md
- 备注：从 raw/LLM 实体抽取.md 编译：生成批量编译测试概念页和 LLM 实体抽取概念页，建立双向链接。

## 2026-07-22 11:17
- 操作类型：compile
- 影响文件：entities/test-document-11.md
- 备注：编译 raw/Test Document 11.md → entities/test-document-11.md（批次编译测试第11号文档）

## 2026-07-22 11:17
- 操作类型：compile
- 影响文件：concepts/batch-compile-testing.md, entities/test-document-12.md, concepts/llm-wiki.md
- 备注：根据原始资料 raw/Test Document 12.md 编译：创建了 batch-compile-testing 概念页、test-document-12 实体页、llm-wiki 概念页，三者已互相建立双向链接。

## 2026-07-22 11:18
- 操作类型：compile
- 影响文件：concepts/batch-compile-testing.md, concepts/llm-wiki.md, concepts/frontmatter.md
- 备注：编译 raw/LLM Wiki.md → concepts/batch-compile-testing.md（主页面），并创建关联页面 llm-wiki.md 和 frontmatter.md。双向链接已建立，index.md 已更新。

## 2026-07-22 11:18
- 操作类型：compile
- 影响文件：entities/test-document-14.md, concepts/wiki-compile.md, concepts/batch-compile-testing.md
- 备注：Compiled raw/test-14.md into entity (Test Document 14) and two related concepts (Wiki Compile, Batch Compile Testing) with bidirectional links established.

## 2026-07-22 11:18
- 操作类型：compile
- 影响文件：entities/test-document-15.md, concepts/batch-compile.md, concepts/llm.md
- 备注：Compiled raw/test-15.md — created entity page for test document, concept page for batch-compile pipeline, and concept page for LLM extraction technique.

## 2026-07-22 11:19
- 操作类型：compile
- 影响文件：entities/test-document-16.md
- 备注：从 raw/Test Document 16.md 编译 Test Document 16 实体页，建立与 batch-compile-testing、wiki-compiler、knowledge-base-compilation、frontmatter-spec 的双向链接
...
- 备注：编译 raw/Batch Compile Test 19.md → concepts/batch-compile-test-19.md（测试实体），同时创建关联概念页 batch-compile-testing.md
...
## 2026-08-14 13:51
- 操作类型：compile
- 影响文件：entities/karpathy-wiki.md
- 备注：从 raw/input-1786715507530.md 编译 Karpathy Wiki 实体页，建立与 llm-wiki 的双向链接

## 2026-08-14 14:03
- 操作类型：compile
- 影响文件：entities/karpathy-wiki.md
- 备注：从 raw/input-1786716214087.md 编译为 entity 页面，验证编译流程。

## 2026-08-14 14:03
- 操作类型：compile
- 影响文件：entities/karpathy-wiki.md, concepts/ai-learning-materials.md
- 备注：根据 raw/input-1786716214087.md 编译 entity 页 karpathy-wiki 及 concept 页 ai-learning-materials，建立双向链接，验证编译流程。

## 2026-08-14 14:05
- 操作类型：compile
- 影响文件：entities/piaoju-yewu-xitong.md
- 备注：编译 raw/batch-a.md：创建票据业务系统 entity 页面，建立与银行对公业务的关联

## 2026-08-14 14:06
- 操作类型：compile
- 影响文件：entities/karpathy-wiki.md
- 备注：从 raw/batch-b.md 编译为 Karpathy Wiki（AI 知识库）实体页，建立与 llm-wiki 的关联链接。

## 2026-08-14 14:14
- 操作类型：compile
- 影响文件：entities/piaoju-yewu-xitong.md, concepts/huipiao-chengdui.md, concepts/huipiao-tiexian.md
- 备注：编译 raw/raw-a.md：生成实体页「中国票据业务系统」及概念页「汇票承兑」「汇票贴现」，建立相互双向链接。

## 2026-08-14 14:17
- 操作类型：compile
- 影响文件：entities/bill-system.md, concepts/huipiao-chengdui.md, concepts/huipiao-tiexian.md
- 备注：从 raw/batch-x.md 编译票据业务系统实体页及汇票承兑、汇票贴现两个概念页，建立双向链接

## 2026-08-14 14:18
- 操作类型：compile
- 影响文件：entities/karpathy-wiki.md
- 备注：从 raw/batch-y.md 编译 Karpathy Wiki 实体页，建立与 llm-wiki、knowledge-base-compilation 的双向链接。

## 2026-08-14 14:32
- 操作类型：compile
- 影响文件：entities/中国票据业务系统.md, entities/上海票据交易所.md, concepts/票据分包.md, concepts/票据签发.md, concepts/票据背书.md, concepts/票据质押.md, concepts/票据保证.md, concepts/票据贴现.md, concepts/票据账户主动管理.md, concepts/票据权利时效.md, concepts/代理签章.md, concepts/票据信息披露.md, concepts/票据状态.md, concepts/票据到期处理.md, concepts/参与者接入.md, concepts/票据资金清算.md, concepts/连续性一致性校验.md, comparisons/票据业务类型对比.md, queries/个体工商户能否承兑电子商业汇票.md
- 备注：从 raw/00中国票据业务系统功能与业务规则202509.md 编译中国票据业务系统知识体系：创建实体页2个（中国票据业务系统、上海票据交易所）、概念页14个（分包/签发/背书/质押/保证/贴现/账户主动管理/权利时效/代理签章/信息披露/状态/到期处理/参与者接入/资金清算/连续性校验）、对比页1个、查询页1个，建立双向链接网络。

## 2026-08-14 14:43
- 操作类型：compile
- 影响文件：entities/中国票据业务系统.md, concepts/票据分包.md, concepts/票据全生命周期业务流程.md, concepts/票据业务参与者接入.md, concepts/票据信息披露机制.md, concepts/票据业务总体规则.md
- 备注：从 raw/00中国票据业务系统功能与业务规则20240822.md 编译生成6个页面：系统实体页、票据分包概念页、全生命周期业务流程概念页、参与者接入概念页、信息披露机制概念页、总体规则概念页

## 2026-08-14 14:45
- 操作类型：compile
- 影响文件：entities/中国票据业务系统.md, concepts/票据分包.md, concepts/票据参与者接入.md, concepts/票据签发.md, concepts/票据流转.md, concepts/票据账户主动管理.md
- 备注：从 raw/00中国票据业务系统功能与业务规则20260608.md 编译中国票据业务系统业务规则：创建 1 个实体页（中国票据业务系统）和 5 个概念页（票据分包、票据参与者接入、票据签发、票据流转、票据账户主动管理），覆盖参与者接入、票据分包、签发、流转、到期处理等全生命周期业务规则。

## 2026-08-14 14:48
- 操作类型：compile
- 影响文件：entities/karpathy-wiki.md, concepts/资料投递自动生成知识库页面.md, concepts/语音朗读.md
- 备注：从 raw/input-1786718832585.md 编译：Karpathy Wiki 实体页及其两个功能概念页（资料投递自动生成知识库页面、语音朗读），并建立双向链接与实体关系

## 2026-08-14 17:14
- 操作类型：compile
- 影响文件：entities/上海票据交易所.md, concepts/电子商业汇票.md, concepts/票付通业务.md, concepts/线上贴现.md, concepts/供应链平台.md, concepts/票据账户主动管理.md, concepts/票据托管账户.md, concepts/业务参与者.md
- 备注：从 raw/01上海票据交易所业务指南202209.md 编译上海票据交易所业务指南相关内容，创建/更新 8 个页面：实体页（上海票据交易所）及概念页（电子商业汇票、票付通业务、线上贴现、供应链平台、票据账户主动管理、票据托管账户、业务参与者），建立双向链接体系

## 2026-08-14 17:15
- 操作类型：compile
- 影响文件：concepts/商业汇票信息披露.md, concepts/票据逾期判定规则.md, entities/上海票据交易所.md, entities/中国人民银行.md
- 备注：编译 raw/02商业汇票信息披露解析202411.md，生成4个页面：1个主概念页（商业汇票信息披露）、1个子概念页（票据逾期判定规则）、2个实体页（上海票据交易所、中国人民银行）。

## 2026-08-14 17:16
- 操作类型：compile
- 影响文件：concepts/有限追索服务.md, entities/上海票据交易所.md
- 备注：编译 03上海票据交易所有限追索服务操作指引：创建有限追索服务概念页和上海票据交易所实体页

## 2026-08-14 17:16
- 操作类型：compile
- 影响文件：concepts/票据业务系统非交易业务客户端.md
- 备注：从 raw/04中国票据业务系统非交易业务客户端功能介绍202509.md 编译为 concept 页面

## 2026-08-14 17:16
- 操作类型：compile
- 影响文件：entities/piaoju-zongfu-pingtai.md
- 备注：编译 raw/05票据综合服务平台业务方案202509.md 为实体页（entity），抽取与上海票据交易所/票据业务系统/票据信息披露平台的关系

## 2026-08-14 17:17
- 操作类型：compile
- 影响文件：entities/上海票据交易所.md, concepts/供应链票据.md, concepts/供应链金融.md, concepts/中国票据业务系统.md, entities/供应链票据平台.md, concepts/电子商业汇票.md, concepts/供应链票据资产证券化.md, concepts/供应链票据有限追索服务.md
- 备注：compiled from raw/06供应链票据平台介绍讲义202511.md — 讲义涵盖供应链票据业务实践、资产证券化及有限追索服务，共生成8个知识页面（2实体+6概念）

## 2026-08-14 17:19
- 操作类型：compile
- 影响文件：concepts/commercial-draft-disclosure.md, entities/shanghai-bill-exchange.md, concepts/commercial-bill-acceptance-discount-rediscount.md, comparisons/bill-overdue-comparison.md, comparisons/bill-type-disclosure-comparison.md
- 备注：从 raw/08商业汇票信息披露解析20260526-发布版.md 编译商业汇票信息披露制度相关页面：创建主概念页（信息披露制度）、实体页（上海票据交易所）、法规概念页（承兑贴现再贴现管理办法），以及两个对比页（票据逾期三级体系对比、商业汇票类型披露要求对比），建立双向链接网络。

## 2026-08-14 17:20
- 操作类型：compile
- 影响文件：concepts/非交易业务客户端功能.md
- 备注：编译 raw/09 中国票据业务系统非交易业务客户端功能介绍 为 concept 页面，建立与中国票据业务系统/ECDS/票交所双向链接

## 2026-08-16 03:58
- 操作类型：compile
- 影响文件：entities/附录1_报文清单.md
- 备注：从 raw/附录1_报文清单.md 编译创建 entity 页面

## 2026-08-16 03:59
- 操作类型：compile
- 影响文件：concepts/xml-schema-naming.md
- 备注：从 raw/readme.txt 编译概念页面：XML Schema 文件命名规则
...
## 2026-08-31 15:14
- 操作类型：compile
- 影响文件：concepts/supply-chain-bill.md
- 备注：从原始资料 raw/07票据云学堂_2026年第1期_供应链票据业务培训.md 编译供应链票据概念页，涵盖基本概念、发展历程、业务实践、产品优势、业务创新（有限追索服务）等内容，建立与上海票据交易所、中国票据业务系统、电子商业汇票、供应链金融、有限追索等页面的双向链接
