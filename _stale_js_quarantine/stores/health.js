...
export const useHealthStore = defineStore('health', () => {
    ...
    const batchDoneKeys = ref(new Set());
    ...
    function handleBatchEvent(eventType, parsed) {
